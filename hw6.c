...
{	
	...
	//lock the passenger mutex lock to initialize the information for that specific passenger
	//pthread_mutex_lock(&Passenger_Information[passenger].lock_for_next);
	...
	//pthread_mutex_unlock(&Passenger_Information[passenger].lock_for_next);
